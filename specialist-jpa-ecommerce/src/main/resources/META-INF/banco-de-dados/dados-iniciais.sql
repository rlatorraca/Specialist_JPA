insert into produto (id, versao, nome_produto, preco, data_criacao, ativo, descricao) values (1, 0, 'Kindle', 599.00, date_sub(sysdate(), interval 4 day), 'SIM', 'Conheça o novo Kindle, agora com iluminação embutida ajustável, que permite que você leia em ambientes abertos ou fechados, a qualquer hora do dia.');
insert into produto (id, versao, nome_produto, preco, data_criacao, ativo, descricao) values (2, 0, 'Câmera GoPro Hero 7', 1500.00, date_sub(sysdate(), interval 3 day), 'SIM', 'Desempenho 2x melhor.');
insert into produto (id, versao, nome_produto, preco, data_criacao, ativo, descricao) values (3, 0, 'Teclado Microsoft', 10.00, date_sub(sysdate(), interval 2 day), 'SIM', 'Mais estiloso que um MAC.');
insert into produto (id, versao, nome_produto, preco, data_criacao, ativo, descricao) values (4, 0, 'Câmera Canon 80D', 3500.0, sysdate(), 'NAO', 'O melhor ajuste de foco.');
insert into produto (id, versao, nome_produto, preco, data_criacao, ativo, descricao) values (5, 0, 'Microfone de Lapela', 123.0, sysdate(), 'SIM', 'O melhor audio de lapela do Brasil.');

insert into cliente (id, versao, nome_cliente, cpf) values (1, 0, 'Fernando Medeiros',"333");
insert into cliente (id, versao, nome_cliente, cpf) values (2, 0, 'Marcos Mariano',"222");
insert into cliente (id, versao, nome_cliente, cpf) values (3, 0, 'Marcelo Prado', "321");
insert into cliente (id, versao, nome_cliente, cpf) values (4, 0, 'Marcelo Prado', "000");
...
insert into pedido (id, versao, cliente_id, data_criacao, total, status) values (3, 0, 2, date_sub(sysdate(), interval 4 day), 3500.0, 'PAGO');
insert into pedido (id, versao, cliente_id, data_criacao, total, status) values (4, 0, 3, date_sub(sysdate(), interval 2 day), 499.0, 'PAGO');
insert into pedido (id, versao, cliente_id, data_criacao, total, status) values (5, 0, 1, date_sub(sysdate(), interval 1 day), 599.0, 'PAGO');
insert into pedido (id, versao, cliente_id, data_criacao, total, status) values (6, 0, 2, sysdate(), 599.0, 'AGUARDANDO');
...
insert into pagamento (pedido_id, versao, status, numero_cartao, codigo_barra, tipo_pagamento) values (1, 0, 'PROCESSANDO', '1234-56987-7777-9999', null, 'cartao');
insert into pagamento (pedido_id, versao, status, numero_cartao, codigo_barra, tipo_pagamento, data_vencimento) values (2, 0, 'RECEBIDO', null, '1234FACE43231-XXX222', 'boleto', date_sub(sysdate(), interval 3 day));
insert into pagamento (pedido_id, versao, status, numero_cartao, codigo_barra, tipo_pagamento, data_vencimento) values (3, 0, 'RECEBIDO', null, '8910', 'boleto', date_sub(sysdate(), interval 2 day));
insert into pagamento (pedido_id, versao, status, numero_cartao, codigo_barra, tipo_pagamento) values (4, 0, 'PROCESSANDO',  '1234-56987-4444-7777', null, 'cartao');
insert into pagamento (pedido_id, versao, status, numero_cartao, codigo_barra, tipo_pagamento, data_vencimento) values (6, 0, 'PROCESSANDO', null, '8910', 'boleto', date_add(sysdate(), interval 2 day));



insert into nota_fiscal (pedido_id, xml, data_emissao) values (2, '<xml />', sysdate());

insert into categoria (id, versao, nome_categoria) values (1, 0, 'Eletrodomésticos');
insert into categoria (id, versao, nome_categoria) values (2, 0, 'Livros');
insert into categoria (id, versao, nome_categoria) values (3, 0, 'Esportes');
insert into categoria (id, versao, nome_categoria) values (4, 0, 'Futebol');
insert into categoria (id, versao, nome_categoria) values (5, 0, 'Natação');
insert into categoria (id, versao, nome_categoria) values (6, 0, 'Notebooks');
insert into categoria (id, versao, nome_categoria) values (7, 0, 'Smartphones');
insert into categoria (id, versao, nome_categoria) values (8, 0, 'Câmeras');
